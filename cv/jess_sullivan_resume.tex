...
Zig, Chapel, Haskell  & NUMA-aware horizontal parallelism    & Enterprise MFA systems \& standards                                                       & RKE2 (k8s) \\
Go, C++, R, Shell     & Realtime model evaluation \& SLM inference & SAML, OAuth, identity interoperability                                                    & GitLab AutoDevOps \\
\end{tabular}
\end{center}
...
\begin{itemize}
    ...
    \item \textbf{Functional \& Heterogeneous Compute:} \tech{Futhark}/\tech{WebGPU}, ESDT monads, pixelwise classification research (\cvlink{https://github.com/Jesssullivan/pixelwise-research}{pixelwise-research}), \tech{Rust} SIMD, \tech{Nix} build systems, deeper WASM integration, and WASM-native inference pipelines.
\end{itemize}
