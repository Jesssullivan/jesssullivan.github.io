...
Go, C++, R, Shell     & Realtime model evaluation \& SLM inference & OpenTelemetry                                                                             & GitLab AutoDevOps \\
\end{tabular}
\end{center}
...
\begin{itemize}
    \item Built a property-based orchestrator and instrumentation harness for 1980s-era degree-management C in \tech{Haskell} + \tech{Python} (QuickCheck, Cabal, podman-compose for dev parity, FPM for packaging, AutoDevOps for CI/CD); turned an unautomatable legacy codebase into a verifiable, traceable, k8s-friendly workload.
