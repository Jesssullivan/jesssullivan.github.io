...
\begin{itemize}
    ...
    \item \textbf{Systems \& research:} Chapel, Rust, Zig, Haskell, GhidraScript, Frida, ILSpy; ABI/FFI work, property-based testing, binary analysis, and performance-oriented systems.
\end{itemize}
