...
\hyperref[sec:ventures]{\textsc{Previous Ventures}} $\cdot$
...
\begin{itemize}
    \item \textbf{Web \& product systems:} \tech{SvelteKit} Runes, \tech{Bun}, \tech{Vite 8} (Rolldown), TS7; auth, scheduling, mapping, telemetry, and site systems.
...
Agent orchestration platform for semiautonomous infrastructure lifecycle management in higher education. Bootstrapped and in stealth; source-available where appropriate. Current work spans SLM-backed automation, multicloud IaC harnesses, Chapel-based parallelism, Kubernetes-native research infrastructure, and public-safe projection surfaces.
