...
\begin{itemize}
    ...
    \item \textbf{Heterogeneous Compute:} \tech{WebGPU}, \tech{Futhark} --- GPU-accelerated workloads and deeper WASM integration for inference pipelines.
    \item \textbf{Functional Programming:} ESDT Monads and \cvlink{https://github.com/Jesssullivan/pixelwise-research}{pixelwise} classification research. \tech{Rust} (SIMD), \tech{Nix}, property-based testing in \cvlink{https://github.com/Jesssullivan/quickchpl}{quickchpl}. With years of friendly pressure from my friend Lena Berlin (Innovation @ Analog Devices, SHARC, Farmblox), 2026 may be my first year of learning Rust in earnest.
\end{itemize}
