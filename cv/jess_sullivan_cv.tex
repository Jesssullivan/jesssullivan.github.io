...
\begin{itemize}
    ...
    \item \textbf{HPC} and performance oriented code written in \textbf{Chapel} and increasingly \textbf{Haskell}; \textbf{TensorFlow}, \textbf{pandas}, NUMA-aware horizontal parallelism, and Realtime model evaluation \& SLM inference from earlier ML production work.
\end{itemize}
