<script lang="ts">
	...
	const dimFiles = import.meta.glob('/static/images/posts/dimensions.json', { eager: true, import: 'default' }) as Record<string, Record<string, { width: number; height: number }>>;
