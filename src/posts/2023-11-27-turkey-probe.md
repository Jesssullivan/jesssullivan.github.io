...
*The server that hosted this image has long since gone dark.* _Turkey Probe in action during thanksgiving_ | *Digital entropy claimed this image when the WordPress site was retired.* _Just moments before thanksgiving_  
---|---
