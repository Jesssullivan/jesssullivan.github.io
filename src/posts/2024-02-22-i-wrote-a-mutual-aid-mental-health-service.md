...
– experiment with horizontal organization structures with minimal hierarchical organization in a traditionally stratified space; enable the trusting reliance of individuals to guide group moderation, while protecting personal info. To do this, function group size is to be limited at 13 individuals (wakeup call groups, digital and in-person group sessions). Additional function groups are to be spawned and destroyed as needed; this group size limit is to be reflected across Tetrahedron.gay projects.
