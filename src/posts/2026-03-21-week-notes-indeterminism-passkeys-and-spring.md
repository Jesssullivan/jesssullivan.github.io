...
The grill is out for first-of-the-spring burgers and I spotted my first groundhog of the year peeking out this morning. Spring is real- also happy belated (ie, right on time) st. Patricks day dear reader, from a real life Sullivan ^w^
...
- I've been dredging up public remnants of [AmbientTalk](https://soft.vub.ac.be/amop/) and have had a fun time swimming around the work of [Coen De Roover](https://soft.vub.ac.be/~cderoove/), hois students and the [AMOP research group](https://soft.vub.ac.be/amop/) at VUB. 
...
Basically, this passkey work has been somewhat spurred on because I bought myself a MacBook Neo to serve as a dedicated "teletype machine" for the wide array of servers in the basement in which (and on which, in the case of the BCI server) I do my work, contracting and projects.  As is tradition, all my little keys, KVMs, evil devices, yubikeys etc have been ceremoniously velcroed to this little macbook- between cmux, qutebrowser and my nix based intellij gateway setup the little screen is all I need, but fido2 support makes it way easier to traverse orgs / glab instances / signing keys / this key store or that keystore / this server or that server etc.  Doing this all via the neo is the goal, thus the PRs.  
